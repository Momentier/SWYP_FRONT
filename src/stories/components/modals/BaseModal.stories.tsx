  ...
  render: (args) => (
    <ModalWrapper {...args}>
      ...
      <div className="max-h-80 overflow-y-auto text-sm text-gray-600 space-y-4">
        <p>
          제1조 (목적) 이 약관은 회사가 제공하는 여행 일정 생성 서비스의 이용과 관련하여 
          회사와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
        <p>
          제2조 (정의) 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
          1. "서비스"라 함은 회사가 제공하는 AI 기반 여행 일정 생성 서비스를 말합니다.
          2. "이용자"라 함은 서비스에 접속하여 이 약관에 따라 서비스를 이용하는 자를 말합니다.
        </p>
        <p>
          제3조 (약관의 효력 및 변경) 이 약관은 서비스를 이용하고자 하는 모든 이용자에 대하여 
          그 효력을 발생합니다. 회사는 필요한 경우 이 약관을 변경할 수 있으며, 변경된 약관은 
          서비스 내 공지사항을 통해 공지됩니다.
        </p>
        <p>
          제4조 (서비스의 제공) 회사는 이용자에게 다음과 같은 서비스를 제공합니다.
...
export const AlwaysOpen: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "스토리북에서 모달의 디자인을 확인하기 위해 항상 열린 상태로 표시됩니다.",
      },
    },
  },
};
