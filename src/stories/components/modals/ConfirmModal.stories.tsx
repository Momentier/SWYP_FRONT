...
export const DeleteConfirm: Story = {
  ...
  args: {
    title: "일정 삭제",
    description: "정말로 이 여행 일정을 삭제하시겠습니까?\n삭제된 일정은 복구할 수 없습니다.",
    cancelText: "취소",
    confirmText: "삭제",
  },
};
...
export const LongDescription: Story = {
  ...
  args: {
    title: "개인정보 수집 동의",
    description: "서비스 개선을 위해 여행 성향과 관련된 정보를 수집합니다.\n수집된 정보는 개인정보 처리방침에 따라 안전하게 보관되며,\n언제든지 철회하실 수 있습니다.\n\n동의하시겠습니까?",
    cancelText: "거부",
    confirmText: "동의",
  },
};
    ...
    <ConfirmModalWrapper {...args}>
      <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
        <Text textStyle="body2" className="text-yellow-800">
          ⚠️ <strong>주의:</strong> 이 작업은 되돌릴 수 없습니다. 신중하게 선택해주세요.
        </Text>
      </div>
    </ConfirmModalWrapper>
  ),
    ...
    <ConfirmModalWrapper {...args}>
      <div className="bg-blue-50 p-4 rounded-lg">
        <div className="flex justify-between items-center mb-2">
          <Text textStyle="body2" className="text-gray-600">프리미엄 플랜</Text>
          <Text textStyle="body1" className="font-semibold">₩9,900</Text>
        </div>
        <div className="flex justify-between items-center">
          <Text textStyle="body2" className="text-gray-600">결제 방법</Text>
