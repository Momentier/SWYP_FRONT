...
const ToastDemo = ({
  ...
  toasts: Array<{ type: "success" | "error"; message: string }>;
}) => {
    ...
    <div className="p-8 space-y-4">
      ...
      <div className="space-x-4">
        ...
        <Button
          variant="gradation"
          onClick={() =>
            addToast("여행 일정이 생성되었습니다. 확인해보세요!", "success")
          }
        >
          긴 성공 메시지
        </Button>
        ...
        <Button variant="press" onClick={clearToasts}>
          모두 지우기
        </Button>
      </div>
      <ToastContainer />
...
export const SuccessToast: Story = {
  render: () => (
    <ToastDemo
      toasts={[{ type: "success", message: "성공적으로 저장되었습니다!" }]}
    />
  ),
};
      ...
      toasts={[
        {
          type: "success",
          message:
            "여행 일정이 성공적으로 생성되었습니다! 마이페이지에서 확인하실 수 있습니다.",
        },
      ]}
    />
  ),
